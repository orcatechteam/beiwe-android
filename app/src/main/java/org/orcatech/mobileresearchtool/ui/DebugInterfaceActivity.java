package org.orcatech.mobileresearchtool.ui;
...
import org.orcatech.mobileresearchtool.BackgroundService;
...
import org.orcatech.mobileresearchtool.Timer;
...
import org.orcatech.mobileresearchtool.survey.JsonSkipLogic;
import org.orcatech.mobileresearchtool.ui.user.MainMenuActivity;
...
//		Log.i("log file encrypted", EncryptionEngine.encryptAES(log) );
	...
	public void getEnabledFeatures(View view) {
		...
		if ( PersistentData.getGyroscopeEnabled() ) { Log.i("features", "Gyroscope Enabled." ); } else { Log.e("features", "Gyroscope Disabled."); }
