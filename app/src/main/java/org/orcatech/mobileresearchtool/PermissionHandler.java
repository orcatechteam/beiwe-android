...
public class PermissionHandler {
	...
	public static String getNormalPermissionMessage(String permission) {
		return String.format("For this study ORCATECH Mobile Research Tool needs permission to %s Please press allow on the following permissions request.", permissionMessages.get(permission) );
	}
	public static String getBumpingPermissionMessage(String permission) {
		return String.format("To be fully enrolled in this study ORCATECH Mobile Research Tool needs permission to %s You appear to have denied or removed this permission. ORCATECH Mobile Research Tool will now bump you to its settings page so you can manually enable it.", permissionMessages.get(permission) );
	}
