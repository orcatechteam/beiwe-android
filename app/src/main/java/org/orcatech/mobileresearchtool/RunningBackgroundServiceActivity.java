...
import org.orcatech.mobileresearchtool.BackgroundService.BackgroundServiceBinder;
...
import org.orcatech.mobileresearchtool.ui.user.AboutActivityLoggedOut;
			...
			if (!prePromptActive && !postPromptActive && !powerPromptActive) {
				if (permission.equals("android.permission.PACKAGE_USAGE_STATS")) {
					showAppUsagePermissionAlert(
						this,
						"ORCATECH Mobile Research Tool needs permission to your app usage data. ORCATECH Mobile Research Tool will now bump you to its settings page so you can manually enable it.",
